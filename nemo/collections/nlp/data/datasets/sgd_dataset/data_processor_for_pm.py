...
class Dstc8DataProcessor(object):
        ...
        for turn_idx, turn in enumerate(dialog["turns"]):
            ...
            if turn["speaker"] == "USER":
                ...
                turn_examples, prev_states = self._create_examples_from_turn(
                    ...
                    system_utterance_next, system_frames_next
                )
                print (turn_examples[0].system_utterance)
                print (turn_examples[0].user_utterance)
    ...
    def _create_examples_from_turn(
        self, turn_id,
        system_utterance, user_utterance, system_frames, user_frames, prev_states,
        schemas,
        ...
        for service, user_frame in user_frames.items():
            ...
            # actions format: ACT-SLOT-SLOT_VALUES
    ...
    # def get_data_for_pm(self):
    #     dialog_paths = [os.path.join(self.dstc8_data_dir, "train", "dialogues_001.json")]
    #     dialogs = Dstc8DataProcessor.load_dialogues(dialog_paths)
    #     return
